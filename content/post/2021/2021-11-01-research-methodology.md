...
An agile experimental protocol would involve defining a dedicated, limited, period of work (for example, 2–12 weeks), called a *sprint*, to work on a set of agreed-upon activities (a.k.a. tasks). Here are the steps of this protocol (from Laura's <a href="https://www.nature.com/articles/d41586-019-01184-9" target="_blank">article</a>):
...
3. **Sprint execution**. Time to work. Here's where you should put your maximum effort to produce the planned goals.
...
The truth is: there is no magic formula for perfect research. But, there are tangible ones towards improving your chances of conducting excellent research, while actually having fun (and tranquillity, and consequently happiness) during the process.
